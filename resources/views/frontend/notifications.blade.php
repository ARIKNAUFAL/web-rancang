...
@section('css')
    <link rel="stylesheet" href="{{ asset('templateFrontend/resources/css/notifications.css') }}">
@endsection

@section('script')
    <script defer src="{{ asset('templateFrontend/resources/JavaScript/request-modal.js') }}"></script>
    <script defer src="{{ asset('templateFrontend/resources/JavaScript/notifications-responsive.js') }}"></script>
@endsection

@section('content')<section class="list-notifiactions">
        <div class="list-notifications-group">
            @foreach ($request as $item)
                <a href="#" class="notification">
                    <div class="content" style="height: 50px;">
                        <div>
                            <p>Your request has been approved: {{ $item->topic }}</p>
